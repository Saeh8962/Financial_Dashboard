...
if(history){
  ...
  var history_data = history.map(data=>{

    ({data:data.open,date:convertHistoryDate(data.date)}))
  }
  console.log(history_date.getMonth(history_data[100].date),history_data[100].date) 
