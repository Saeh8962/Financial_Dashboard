...
app.post('/api/getStockInfo', function(req, res){
    ...
    // async function getStockQoute(symblol){
        
    //     await request('https://finnhub.io/api/v1/quote?symbol='+symblol+'&token=c34391qad3i8edlcgrgg', { json: true }, (err, res, body) => {
