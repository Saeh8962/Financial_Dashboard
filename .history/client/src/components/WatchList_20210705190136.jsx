...
// import { insertItem, getItems, updateItem, deleteItem } from "./services.ts";
...
export default class WatchList extends React.Component {
    ...
    <GridColumn title="Symbol" field="Symbol" locked={true} width={100} headerCell={ProductNameHeader}/>
    <GridColumn title="Current Price" field="currentPrice" />
    <GridColumn cell={<button className="k-button k-grid-remove-command"
                onClick={() =>
                  this.remove
                }
              >
