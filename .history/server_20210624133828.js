...
// })
app.post('/api/getStockInfo', function(req, res){
    var stock_symbol = toString(req.body.stock_to_watch);
    console.log(stock_symbol);
    var info = getStockQoute(stock_symbol);
    
    function getStockQoute(symblol){
        request('https://finnhub.io/api/v1/quote?symbol='+symblol+'&token=sandbox_c34391qad3i8edlcgrh0', { json: true }, (err, res, body) => {
