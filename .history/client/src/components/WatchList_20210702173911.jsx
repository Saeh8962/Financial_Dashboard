...
this.props.history.push("/profile",[[{email:this.state.email}],this.state.stocks])          this.getUserStocks();
        }
      }
    toggle(event) {
        this.setState({
    ...
    removeHelper(){
        ...
        //stock has been removed from watchlist
            ...
            console.log("p/212");
            this.setState({stocks:this.state.remove_status.Data},()=>this.UpdateStockOnPage);
        }
    }
    getUserStocks(){
        var user={ 
