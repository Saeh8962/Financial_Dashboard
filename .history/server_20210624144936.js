...
// })
var info ="";
app.post('/api/getStockInfo', async function(req, result){
    var stock_symbol = req.body.stock_to_watch;
    var info;
    
        var x = await request('https://finnhub.io/api/v1/quote?symbol='+stock_symbol+'&token=c34391qad3i8edlcgrgg', { json: true }, (err, res, body) => {
