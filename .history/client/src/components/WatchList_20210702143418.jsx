...
class WatchList extends React.Component {
    ...
    removeHelper(){
        ...
        //stock has been removed from watchlist
            ...
            console.log("p/212");
            this.setState({stocks:this.state.remove_status[1]});
        }
    }
    getUserStocks(){
        var user={ 
        ...
        .then(stock_results => this.setState({stocks:stock_results}));
    ...
    UpdateStockOnPage(){
        if(this.state.stock_symbol_status === 'User had already added this stock'){
            ...
            this.connection.send(JSON.stringify({'type':'subscribe', 'symbol': this.state.stock_to_watch})).then(()=>this.setState({stock_symbol_status:"",Remove_Status:""},()=>this.getUserStocks()));
