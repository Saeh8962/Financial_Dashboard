...
class Profile extends Component { 
    ...
    componentDidUpdate(prevProps, prevState) {
        if (prevProps.location.state[0][0].getStocks !==this.props.location.state[0][0].getStocks ===true) {
          console.log('User has added a stock. Get new stocks')
          this.getUserStocks()
          
        }
        if (prevProps.location.state[0][0].removeStocks !== this.props.location.state[0][0].RemoveStocks ===true) {
