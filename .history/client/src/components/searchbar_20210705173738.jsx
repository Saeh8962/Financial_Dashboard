...
export default class SearchBar extends React.Component{
  ...
  componentDidUpdate(prevProps, prevState) {
    if (prevState.stockHasbeenAdded !== this.state.stockHasbeenAdded) {
      ...
      this.props.history.push("/profile",[[{email:this.state.email,getStocks:true},this.state.stocks]]);
    }
  }
  UpdateStockOnPage(){
    if(this.state.stock_symbol_status === 'User had already added this stock'){
        ...
        this.setState({stockHasbeenAdded:true},()=>this.getUserStocks);
    }
}
addUserStock(){
        ...
        <PanelBarItem expanded={true} title="Add Stocks">
          <form className= "FormFields">
            <div className="FormField">
              ...
              <span className = "play"><Button  className= "ButtonNoRight" onClick={this.addUserStock}>Track </Button><input  className= "FormField_Input" onChange={this.handleChange} placeholder= "Stock Name" type="text" name="stock" /></span> 
            </div>
          </form>
      </PanelBarItem>
      <PanelBarItem expanded={true} title="Add Stocks">
          <form className= "FormFields">
            <div className="FormField">
              ...
              <span className = "play"><Button  className= "ButtonNoRight" onClick={this.addUserStock}  >Track </Button></span> 
            </div>
          </form>
      </PanelBarItem>
    </PanelBar>
