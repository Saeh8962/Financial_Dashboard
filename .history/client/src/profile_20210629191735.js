...
componentDidMount(){
    ...
    if(this.state.stocks!==null && this.state.stocks!=="No stocks added") {
        var user_watchlist = this.state.stocks
        this.ws.onopen = () => {
        // on connecting, do nothing but log it to the console
        user_watchlist.Symbol.forEach(symbol=>this.ws.send(JSON.stringify({'type':'subscribe', 'symbol': user_watchlist.Symbol})))
