...
class Profile extends Component { 
    ...
    getStockInfo(){
        ...
        console.log(user.stock_to_watch);
        ...
        .then(api_result=>{
            this.setState({symbol:this.state.stock_to_watch,stocks:{stock_info:api_result}} )
            return this.state;
        }) 
        .catch((error)=>{
        ...
        <form className= "FormFields">
          <div className="FormField">
            <input onChange={this.handleChange} className= "FormField_Input" placeholder= "Stock Name" type="text" name="artist" />
             <Button onClick={this.getStockInfo} className= "ButtonNoRight" >Track </Button>
          </div>
          {dropdown}
