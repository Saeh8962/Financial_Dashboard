...
class WatchList extends React.Component {
    ...
    componentWillMount(){
        ...
        this.connection.onopen = ()=> { 
            if (this.props.stocks!=="No stocks added"){
                this.props.stocks.forEach(symbol=>{
    ...
    saveNewStockTrade= (event) => {
        ...
        console.log(result)
        let user_watchlist = this.props.stocks
    ...
    removeHelper(){
        ...
        //stock has been removed from watchlist
            ...
            console.log("p/212");
            this.setState({stocks:this.state.remove_statusData},()=>this.updatePage);
        }
    }
    getUserStocks(){
        var user={ 
    ...
    render(){
        ...
        <Dropdown style = {{marginBottom:"20px"}} isOpen={this.state.dropdownOpen}>
            ...
            <DropdownMenu className = "DDM">
              <div className = "ArtistsDisplayWrapper">
                {this.props.stocks.map((stocks,index) =>
