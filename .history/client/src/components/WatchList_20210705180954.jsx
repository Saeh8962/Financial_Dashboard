...
import {Button,DropdownMenu,Dropdown,Tooltip,OverlayTrigger} from "reactstrap/es";
...
export default class WatchList extends React.Component {
    ...
    <Button variant="success"><GridColumn title="Symbol" field="Symbol" locked={true} width={100} /></Button>
            </OverlayTrigger>,
