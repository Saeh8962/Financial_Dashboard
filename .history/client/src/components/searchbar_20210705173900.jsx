        ...
        <PanelBarItem expanded={true} title="Add Stocks">
          <form className= "FormFields">
            <div className="FormField">
              ...
              <Button  className= "ButtonNoRight" onClick={this.addUserStock}>Track </Button>
              <input  className= "FormField_Input" onChange={this.handleChange} placeholder= "Stock Name" type="text" name="stock" />
            </div>
          </form>
      </PanelBarItem>
      <PanelBarItem expanded={true} title="Add Stocks">
