        ...
        <PanelBarItem expanded={true} title="Add Stocks">
          <form className= "FormFields">
            <div className="FormField">
              ...
              <span className = "play"><input  className= "FormField_Input" onChange={this.handleChange} placeholder= "Stock Name" type="text" name="stock" /><Button  className= "ButtonNoRight" onClick={this.addUserStock}  >Track </Button></span> 
            </div>
          </form>
      </PanelBarItem>
      <PanelBarItem expanded={true} title="Add Stocks">
