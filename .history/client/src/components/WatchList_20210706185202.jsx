...
//     }
    ...
    <GridColumn title="Symbol" field="Symbol"style={{ width: 100 }} cell={viewChartOver} locked={true} width={100} />
    <GridColumn title="Current Price" field="currentPrice" />
    {/* cell={this.CommandCell} */}
    <GridColumn title="View Chart" id="Symbol" cell={viewChartOver} width="200px" />
